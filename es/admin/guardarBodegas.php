...
define('UPLOAD_DIR_ES', 'img/Bodegas/');
define('UPLOAD_DIR_EN', '../../en/admin/img/Bodegas/');
define('UPLOAD_DIR_DE', '../../de/admin/img/Bodegas/');
define('UPLOAD_DIR_CA', '../../ca/admin/img/Bodegas/');
...
if ( !empty($_POST) ) {
 ...
 //    $password   = "root";
	...
	$name3 = "sec3_img_3_".date("Y-m-d_H-i-s");
	// Datos Sección 3
	$strSec3 = "UPDATE sec_3_bodegas SET img_1 = '".$name1.".jpg', img_2 = '".$name2.".jpg', img_3 = '".$name3.".jpg' WHERE id = 1 ";
	$qrySec3 = mysqli_query($conexion, $strSec3);
