...
<body>
					...
					<div class="idioma">
						<div class="row">
							<div class="col-md-8 col-md-offset-2">
								<div class="row">
									<div class="col-md-3 col-sm-3 sin-padding-lr sel-language current" data-language="es">
										<p class="txt-language borde">Español</p>
										<img class="img-responsive center-block" src="img/bandera1.png" alt="">
									</div>
									<div class="col-md-3 col-sm-3 sin-padding-lr sel-language" data-language="ca">
										<p class="txt-language borde">Catalán</p>
										<img class="img-responsive center-block" src="img/bandera2.png" alt="">
									</div>
									<div class="col-md-3 col-sm-3 sin-padding-lr sel-language" data-language="en">
										<p class="txt-language borde">English</p>
										<img class="img-responsive center-block" src="img/bandera3.png" alt="">
									</div>
									<div class="col-md-3 col-sm-3 sin-padding-lr sel-language" data-language="de">
										<p class="txt-language">Deutsch</p>
	...
	<script>
		$(document).ready(function () {
			...
			$(".sel-language").click(function () {
				$(".sel-language").removeClass("current");
			...
			$(".btn-ingresar").click(function () {
				...
				console.log(str[0]);
				if ( str[0] >= 18 ) {
					window.location = language+"/index.php";
				} else {
