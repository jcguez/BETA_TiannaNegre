...
<body>
	...
	<div class="container-video container-menu">
		<div class="container-full-img">
			...
			// $imgE1 = file_get_contents('img/ImasD/'.$rowHead['img']);
			...
			<div class="row sec-3-bodegas">
				<div class="col-md-8 col-md-offset-2">
					...
					if ( $numSec3 == 1 ) {
						...
						$imgE1 = file_get_contents('img/ImasD/'.$rowSec3['img_1']);
                        $imgData1 = base64_encode($imgE1);
                        $imgData1 = str_replace('dataimage/jpgbase64', '', $imgData1);

                        $imgE2 = file_get_contents('img/ImasD/'.$rowSec3['img_2']);
                        $imgData2 = base64_encode($imgE2);
                        $imgData2 = str_replace('dataimage/jpgbase64', '', $imgData2);

                        $imgE3 = file_get_contents('img/ImasD/'.$rowSec3['img_3']);
		...
		<div class="container-fluid">
			<div class="row sec-2-bodegas">
				<div class="col-md-8 col-md-offset-2">
					<div class="tit-sec">
						<?php 
						$strSec2 = "SELECT * FROM sec_2_imasd LIMIT 1";
					...
					<div class="desc-sec">
						<div id="galeria" class="row">
							...
							while ( $rowSec2I = mysqli_fetch_array($qrySec2I) ) {
								$imgE1 = file_get_contents('img/ImasD/'.$rowSec2I['img']);
                                $imgData1 = base64_encode($imgE1);
                                $imgData1 = str_replace('dataimage/jpgbase64', '', $imgData1);
								 ?>
	    ...
	    $(document).ready(function() {
	    	...
	    	var owl = $("#owl-vinos");
		  	...
		  	$("#btn-act-pagina").click(function () {
		  		...
		  		console.log(sec3);
		  		$.ajax({
		  			url: "guardarImasd.php",
		  			type: "POST",
		  			dataType: "json",
		  			data: { sec1: sec1, sec2: sec2, sec3: sec3, head: head },
		  			success: function (datos) {
		  				console.log(datos);
		  				if ( datos.estatus == "success" ) {
		  					alert("Página actualizada correctamente.");
		  					window.location.href = "imasd.php";
		  				} else {
