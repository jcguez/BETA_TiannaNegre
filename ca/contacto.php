			...
			<div class="row sec-3-bodegas">
				<div class="col-md-8 col-md-offset-2">
					...
					<div class="desc-sec no-margin-top">
						...
						<p class="texto-desc-sec">Vine i descobreix el món del vi!</p>
						...
						<div class="tit-sec">
							...
							<form class="form-contacto" role="form">
							  	<div class="form-group">
								    <label>nom</label>
							    	<input type="text" class="form-in" placeholder="nom complet" required="">
							  	</div>
							  	<div class="form-group">
								    <label>email</label>
							    	<input type="email" class="form-in" placeholder="email@exemple.com" required="">
							  	</div>
							  	<div class="form-group">
								    <label>telèfon</label>
							  	...
							  	<div class="form-group">
							    	...
							    	<textarea class="form-txt" name="" rows="4" placeholder="Vull fer una visita el dia..." required=""></textarea>
							  	</div>
