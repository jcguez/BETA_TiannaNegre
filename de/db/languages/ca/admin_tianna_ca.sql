...
-- Tiempo de generación: 01-05-2017 a las 09:32:37
...
CREATE TABLE `banner_home` (
  `id` int(11) NOT NULL,
  `slogan` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Texto del banner',
  `txt_btn` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Texto del botón del banner',
  `link_btn` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Enlace del botón del banner'
...
CREATE TABLE `categorias` (
  ...
  `img_header` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `detalles_aceite` (
  `id` int(11) NOT NULL,
  `titulo1` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `texto1` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `titulo2` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `texto2` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `titulo3` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `texto3` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `titulo4` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `texto4` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `titulo5` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `texto5` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `detalles_vino` (
  ...
  `variedades` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'variedades de uva',
  `vendimia` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `elaboracion` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `crianza` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `nota_cata` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'nota de cata',
  `produccion` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `grado_alcoholico` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `area_produccion` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `temperatura` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'temperatura de servicio',
  `nota_maridaje` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `presentaciones` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `orden` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `header_aceite` (
  `id` int(11) NOT NULL,
  `img` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `img_responsive` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, 'headerBack2017-04-26_23-08-53.jpg', 'FondoA.jpg');
...
(1, 'head_imasd_2017-04-27_04-32-47.jpg', 'FondoB.jpg');
...
CREATE TABLE `productos` (
  ...
  `img` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Miniatura del producto en PNG',
  `orden` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, 'reservaciones', 'aparta tu visita', '<p>También podrás ver, según la época del año, la entrada de la uva vendimiada, la fermentación del vino, los trasiegos en la sala de crianza, el embotellado, etc.</p>\\n<p>Disfruta de esta experiencia única e inolvidable y déjate seducir por las sensaciones más auténticas del vino.</p>\\n<p class="texto-desc-sec">¡Ven y descubre el mundo del vino!</p>', '¿cómo puedo hacer mi reservación?', 'img_reserva_1_2017-04-26_23-08-53.jpg', '<p>Llama al +34 971 886 826 / 661 224 109, de 09:00 a 16:00 horas.</p>\\n<p>Manda un email a info@tiannanegre.com y nosotros nos pondremos en contacto contigo para formalizar la reserva.</p>', 'visita celler tianna negre', 'img_reserva_2_2017-04-26_23-08-53.jpg', '<p>Las visitas al Celler Tianna Negre son de lunes a viernes de 10:00h a 16:00h.</p>\\n<p>Imprescindible reserva previa para cualquier fecha y horario.</p>');
...
CREATE TABLE `seccion_contacto` (
  `id` int(11) NOT NULL,
  `domicilio` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `telefono` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `email` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `fb` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Facebook',
  `tw` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Twitter',
  `gp` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Google+',
  `be` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Behance',
  `it` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Instagram'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, 'Xisca Morey', 'img_equipo_0_2017-04-28_13-29-58.jpg', '<i>"El vino es como un proyecto arquitectónico. A través de unas premisas que te da el campo, la viña, el clima, hasta llegar al producto final. La obra ya está realizada"</i> Xisca Morey (Gerencia, Arquitecta)'),
(2, 'Antonia Garau', 'img_equipo_1_2017-04-28_13-29-58.jpg', '<i>"El tiempo de Vermar es la culminación del trabajo de todo un año, extraer el vino es el fruto de todo un año."</i> Antonia Garau (Propietaria Tianna Negre)'),
(3, 'Joan Toni Lladó', 'img_equipo_2_2017-04-28_13-29-58.jpg', '"El vi es passió i plaer" Joan Toni Lladó (Responsable Celler)');
...
(1, 'Tienda', 'Nuestra tienda es más que una tienda, es una experiencia única en sí misma donde encontrará:\\nUna atención individual con asesoramiento y cata de degustación previa a la adquisición del producto, toda la variedad de los vinos que elaboramos en nuestra propia bodega y\\nnuestro aceite Tianna Negre Virgen Extra.'),
...
CREATE TABLE `seccion_video` (
  ...
  `descripcion` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ruta` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `sec_2_bodegas` (
  ...
  `subtitulo` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `sec_3_bodegas` (
  ...
  `titulo` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `subtitulo` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `img_1` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ttl_1` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `txt_1` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `img_2` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ttl_2` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `txt_2` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `img_3` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `ttl_3` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `txt_3` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, '-visitanos ImasD', '-en nuestras instalaciones', 'sec3_img_1_2017-04-27_04-32-47.jpg', '-Viñedos', '-ImasD Siempre hemos contado con el apoyo y asesoramiento de profesionales viticultores y enólogos.\\nNuestro concepto vitícola no es solo un concepto varietal sino que lo importante es el conjunto de tierra-cepa-clima-cuidados. <strong>Nuestros viñedos se encuentran ubicados en los términos municipales de Binissalem y Consell, pertenecientes ambos a la región de la D.O. Binissalem, Mallorca. </strong>', 'sec3_img_2_2017-04-27_04-32-47.jpg', '-Instalaciones', '-ImasD La arquitectura del "Celler Tianna Negre" es una muestra clara de conjugación de diseño arquitectónico, funcionalidad y respeto al medio ambiente. El resultado es un potente y espectacular edificio completamente integrado en el entorno, y con unas condiciones óptimas de uso energético, de trabajo y de productividad - características todas ellas que revierten en el resultado final de nuestros vinos.', 'sec3_img_3_2017-04-27_04-32-47.jpg', '-Equipo', '-ImasD Tianna Negre es un proyecto que se ha hecho realidad gracias, sobre todo, a su equipo humano. Su vocación, compromiso, interés por una mejora permanente y su dedicación absoluta son su mejor garantía. <strong> El objetivo de todas las personas que componen el equipo de Tianna Negre es despertar en nuestros clientes la misma pasión que originó este proyecto.  </strong>');
...
CREATE TABLE `sld_2_bodegas` (
  `id` int(11) NOT NULL,
  `nombre` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Nombre que aparecerá en caso de que no muestre imagen',
  `img` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `orden` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, 'Imagen imasd', 'sld_imasd_0_2017-04-27_04-32-47.jpg', 0),
(2, 'Imagen imasd', 'sld_imasd_1_2017-04-27_04-32-47.jpg', 1),
(3, 'Imagen imasd', 'sld_imasd_2_2017-04-27_04-32-47.jpg', 2),
(4, 'Imagen imasd', 'sld_imasd_3_2017-04-27_04-32-47.jpg', 3),
(5, 'Imagen imasd', 'sld_imasd_4_2017-04-27_04-32-47.jpg', 4),
(6, 'Imagen imasd', 'sld_imasd_5_2017-04-27_04-32-47.jpg', 5),
(7, 'Imagen imasd', 'sld_imasd_6_2017-04-27_04-32-47.jpg', 6),
(8, 'Imagen imasd', 'sld_imasd_7_2017-04-27_04-32-47.jpg', 7),
(9, 'Imagen imasd', 'sld_imasd_8_2017-04-27_04-32-47.jpg', 8),
(10, 'Imagen imasd', 'sld_imasd_9_2017-04-27_04-32-47.jpg', 9),
(11, 'Imagen imasd', 'sld_imasd_10_2017-04-27_04-32-47.jpg', 10),
(12, 'Imagen imasd', 'sld_imasd_11_2017-04-27_04-32-47.jpg', 11),
(13, 'Imagen imasd', 'sld_imasd_12_2017-04-27_04-32-47.jpg', 12),
(14, 'Imagen imasd', 'sld_imasd_13_2017-04-27_04-32-47.jpg', 13),
(15, 'Imagen imasd', 'sld_imasd_14_2017-04-27_04-32-47.jpg', 14);
...
(1, '- -', 'img_slide_0_2017-04-28_13-29-58.jpg', 0);
...
CREATE TABLE `usuarios` (
  ...
  `contrasena` varchar(70) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, 'videoHomeBack2017-04-28_13-29-58.mp4', 'imagenVideo2017-04-28_13-29-58.jpg');
