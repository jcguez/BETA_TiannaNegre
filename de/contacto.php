			...
			<div class="row sec-3-bodegas">
				<div class="col-md-8 col-md-offset-2">
					...
					<div class="desc-sec no-margin-top">
						...
						<p class="texto-desc-sec">Kommen Sie und die Welt des Weins entdecken!</p>
						...
						<div class="tit-sec">
							...
							<form class="form-contacto" role="form">
							  	<div class="form-group">
								    <label>name</label>
							    	<input type="text" class="form-in" placeholder="vollständige namen" required="">
							  	</div>
							  	<div class="form-group">
								    <label>e-mail</label>
							    	<input type="email" class="form-in" placeholder="email@beispiel.com" required="">
							  	</div>
							  	<div class="form-group">
								    <label>telefon</label>
							  	...
							  	<div class="form-group">
							    	...
							    	<textarea class="form-txt" name="" rows="4" placeholder="Ich möchte den Tag besuchen..." required=""></textarea>
							  	</div>
							  	<button type="submit" class="btn btn-default btn-enviar">senden</button>
							</form>
