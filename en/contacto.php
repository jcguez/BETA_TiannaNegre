							...
							<div class="no-padding-top no-padding-bottom">
								...
								<nav style="height: 1px;" aria-expanded="false" class="navbar-collapse collapse" id="bs-navbar">
									<ul class="nav navbar-nav navbar-right">
										<li class="item-menu">
											<a href="bodegas.php">cellar</a>
										</li>
										<li class="item-menu">
											<a href="vinos.php">the wines</a>
										</li>
										<li class="item-menu">
											<a href="aceite.php">oil</a>
										</li>
										<li class="item-menu">
											<a href="imasd.php">i + d</a>
										</li>
										<li class="item-menu current">
											<a href="contacto.php">visit us</a>
										</li>
									</ul>
								</nav>
							</div>
			...
			<div class="row sec-3-bodegas">
				<div class="col-md-8 col-md-offset-2">
					...
					<div class="desc-sec no-margin-top">
						...
						<p class="texto-desc-sec">Come and discover the world of wine!</p>
						...
						<div class="tit-sec">
							...
							<form class="form-contacto" role="form">
							  	<div class="form-group">
								    <label>name</label>
							    	<input type="text" class="form-in" placeholder="full name" required="">
							  	</div>
							  	<div class="form-group">
								    <label>email</label>
							    	<input type="email" class="form-in" placeholder="email@example.com" required="">
							  	</div>
							  	<div class="form-group">
								    <label>phone</label>
							    	<input type="text" class="form-in" placeholder="12 34 56 78" required="">
							  	</div>
							  	<div class="form-group">
								    <label>message</label>
							    	<!-- <input type="text" class="form-in" placeholder="Introduce tu email"> -->
							    	<textarea class="form-txt" name="" rows="4" placeholder="I want to visit the day..." required=""></textarea>
							  	</div>
							  	<button type="submit" class="btn btn-default btn-enviar">submit</button>
							</form>
						...
						<div class="row">
							<div class="col-md-6">
								<ul class="menu-footer">
									...
									<li><a href="bodegas.php">cellar</a></li>
									<li><a href="vinos.php">the wines</a></li>
									<li><a href="aceite.php">oil</a></li>
								</ul>
							</div>
							<div class="col-md-6">
								<ul class="menu-footer">
									<li><a href="imasd.php">i + d</a></li>
									<li><a href="contacto.php">visit us</a></li>
								</ul>
							</div>
						</div>
					</div>
					<div class="col-md-4 col-footer col-xs-6">
						<h5 class="title-footer-menu">Contact</h5>
						<div class="row">
							<div class="col-md-12">
								<ul class="menu-footer">
