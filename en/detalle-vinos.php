					...
					<div class="col-md-8 item-row-lft">
				        ...
				        <div class="row">
					        ...
					        while ( $rowHash = mysqli_fetch_array($qryHash) ) {
					         ...
					         ?>
					        	<a class="button secondary url col-md-3 col-sm-3 col-xs-3 no-padding-left no-padding-right" href="#det-<?php echo $rowHash['id'] ?>">
					...
					// }
				  	...
				  	while ( $rowProds = mysqli_fetch_array($qryProds) ) {
			    		...
			    		$imgData3 = str_replace('dataimage/jpegbase64', '', $imgData3);
				  		 ?>
					  	<!-- <div class="item item-proc-aceite">
					  		<div class="cont-img-vino">
								<img src="data:image/jpeg;base64,<?php //echo $imgData3 ?>" alt="" class="img-responsive" style="width: auto;">
							</div>
							<h4 class="strong">Vélorosé</h4>
					  	</div> -->
					  	<div class="item-vino" onclick="javascript:location.href='detalle-vinos.php?vino=<?php echo $rowProds['id'] ?>'">
