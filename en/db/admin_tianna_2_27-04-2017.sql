...
--
-- Servidor: localhost
-- Tiempo de generación: 27-04-2017 a las 19:33:33
...
(1, 'headerBack2017-03-26_23-49-25.jpg', 'FondoA.jpg');
...
(1, '*reservaciones', '*aparta tu visita', '*<p>También podrás ver, según la época del año, la entrada de la uva vendimiada, la fermentación del vino, los trasiegos en la sala de crianza, el embotellado, etc.</p>\\n<p>Disfruta de esta experiencia única e inolvidable y déjate seducir por las sensaciones más auténticas del vino.</p>\\n<p class=\"texto-desc-sec\">¡Ven y descubre el mundo del vino!</p>', '*¿cómo puedo hacer mi reservación?', 'img_intro_1_2017-04-26_19-57-27.jpg', '*<p>Llama al +34 971 886 826 / 661 224 109, de 09:00 a 16:00 horas.</p>\\n<p>Manda un email a info@tiannanegre.com y nosotros nos pondremos en contacto contigo para formalizar la reserva.</p>', '*visita celler tianna negre', 'img_intro_2_2017-04-26_19-57-27.jpg', '*<p>Las visitas al Celler Tianna Negre son de lunes a viernes de 10:00h a 16:00h.</p>\\n<p>Imprescindible reserva previa para cualquier fecha y horario.</p>');
